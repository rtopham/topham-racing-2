    ...
    return (
      <Panel className="statsPanel">
        ...
        <ListGroup>
          ...
          <ListGroupItem><img alt="Series Logo" className="logoimage" src={icupLogo}/>&nbsp;ICUP Races: {this.props.alltimeStats.ICUP}</ListGroupItem>
          <ListGroupItem><img alt="Series Logo" className="logoimage" src={mwLogo}/>&nbsp;Mid-Week Races: {this.props.alltimeStats.Midweek}</ListGroupItem>
          <ListGroupItem><img alt="Series Logo" className="logoimage" src={USACLogo}/>&nbsp;USAC Races: {this.props.alltimeStats.USAC}</ListGroupItem>
          <ListGroupItem><img alt="Series Logo" className="logoimage" src={chainRing}/>&nbsp;Other Races: {this.props.alltimeStats.Other}</ListGroupItem>
