...
//console.log(req.body)
  Race.findByIdAndUpdate(req.race._id, {$set:{series: req.body.series, race_name: req.body.race_name, race_date:req.body.race_date, location:req.body.location,time:req.body.time,rank:req.body.time,rank:req.body.rank,category:req.body.category}})
  .exec((err, result) => {
    if (err) {
      return res.status(400).json({
        error: errorHandler.getErrorMessage(err)
